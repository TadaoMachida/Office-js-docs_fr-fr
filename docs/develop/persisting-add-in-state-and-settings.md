...
# Conservation de l’état et des paramètres des compléments
...
## Persistance de l’état et des paramètres d’un complément avec l’interface API JavaScript pour Office
...
## Données de paramètres gérées en mémoire à l’exécution
...
### Création ou mise à jour d’une valeur de paramètre
...
## Enregistrement des paramètres dans la boîte aux lettres de l’utilisateur pour les compléments Outlook en tant que paramètres d’itinérance
...
## Enregistrement des paramètres par élément pour les compléments Outlook en tant que propriétés personnalisées
