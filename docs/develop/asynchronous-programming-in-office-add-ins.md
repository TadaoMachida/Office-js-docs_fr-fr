...
## Écriture de la fonction de rappel pour une méthode « Async »
...
### Écriture d’une fonction de rappel anonyme
...
### Écriture d’une fonction de rappel nommée
...
#### Utilisation des fonctions anonymes pour des rappels imbriqués
...
#### Utilisation de fonctions nommées pour des rappels imbriqués
...
## Passage de paramètres facultatifs à des méthodes asynchrones
...
### Passage de paramètres facultatifs incorporés
...
### Passage de paramètres facultatifs dans un objet options
