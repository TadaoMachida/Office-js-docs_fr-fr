...
La procédure décrite ci-dessous vous guide tout au long du processus de création d’un simple complément de volet de tâches permettant de charger des données dans une feuille de calcul et de créer un graphique de base dans Excel 2016.
