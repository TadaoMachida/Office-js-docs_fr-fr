...
|:---------------|:--------|:----------|
|body|[Body](body.md)|Obtient le corps du document. Le corps du document correspond à l’ensemble du texte, à l’exception des en-têtes, des pieds de page, des notes de bas de page, des zones de texte, etc. En lecture seule.|
