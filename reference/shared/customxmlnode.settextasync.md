...
# Méthode CustomXmlNode.setTextAsync
...
|:-----|:-----|:-----|
| _text_|**string**|Obligatoire. Valeur de texte du nœud XML.|
...
| _callback_|**object**|Facultatif. Fonction appelée quand le rappel est renvoyé, dont le seul paramètre est de type **AsyncResult**.|
