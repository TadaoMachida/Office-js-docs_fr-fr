...
# Méthode CustomXmlPrefixMappings.addNamespaceAsync
...
|:-----|:-----|:-----|:-----|
| _prefix_|**string**|Spécifie le préfixe à ajouter à la liste de mappages de préfixes. Requis.||
| _ns_|**string**|Spécifie l’espace de noms à affecter au préfixe qui vient d’être ajouté. Requis.||
