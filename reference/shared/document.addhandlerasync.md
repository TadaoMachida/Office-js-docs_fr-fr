...
# Méthode Document.addHandlerAsync
Ajoute un gestionnaire d’événements pour un événement d’objet **Document**.

|||
|:-----|:-----|
|**Hôtes :**|Excel, PowerPoint, Project, Word|
|**Disponible dans l’[ensemble de ressources requis](../../docs/overview/specify-office-hosts-and-api-requirements.md)**|DocumentEvents|
|**Ajouté dans**|1.1|
...
| _handler_|**object**|Fonction de gestionnaire d’événements à ajouter, dont le seul paramètre est de type [DocumentSelectionChangedEventArgs](../../reference/shared/document.selectionchangedeventargs.md). Requis.||
...
|||
|:-----|:-----|
|**Disponible dans les ensembles de ressources requis**|DocumentEvents|
