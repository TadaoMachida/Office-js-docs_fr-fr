...
# Méthode Bindings.getByIdAsync
Obtient la liaison spécifiée par son identificateur.

|||
|:-----|:-----|
|**Hôtes :**|Access, Excel, Word|
|**Disponible dans l’[ensemble de ressources requis](../../docs/overview/specify-office-hosts-and-api-requirements.md)**|CustomXmlParts, MatrixBindings, TableBindings, TextBindings|
...
|:-----|:-----|:-----|:-----|
| _id_|**string**|Spécifie le nom unique à utiliser pour identifier l’objet de liaison. Requis.||
...
|||
|:-----|:-----|
|**Disponible dans les ensembles de ressources requis**|CustomXmlParts, MatrixBindings, TableBindings, TextBindings|
