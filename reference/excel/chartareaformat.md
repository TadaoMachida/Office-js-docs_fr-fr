# Objet ChartAreaFormat (interface API JavaScript pour Excel)
...
|font|[ChartFont](chartfont.md)|Représente les attributs de police (nom de la police, taille de police, couleur, etc.) de l’objet. En lecture seule.|
